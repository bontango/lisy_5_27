		...
		fgets(input, sizeof(input), stdin);
                ...
                switch ( tolower ( input[0] ))
				   ...
				   break;
                         case 't': coil_test();
				   break;
                         case 'k': coil_getme_k3();
				   break;
                         case 'm': coil_get_mpu_dips();
				   break;
                         case 'h':
			 case '?': lisy_help(position);
                                   break;
...
lisy80_get_dips();
 ...
 //init coils
if ( lisy_hardware_revision == 100 ) lisy1_coil_init( );
 else lisy80_coil_init( );
